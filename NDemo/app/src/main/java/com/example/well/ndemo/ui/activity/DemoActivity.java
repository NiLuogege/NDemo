...
import com.example.well.ndemo.mapbackground.LocationStatusManager;
...
//        registerReceiver(locationChangeBroadcastReceiver, intentFilter);
    ...
    public void startService(View v) {
        if (buttonStartService.getText().toString().equals("开始定位")) {
            ...
            buttonStartService.setText("结束定位");
...
//                if (BuildConfig.DEBUG) Log.e("DemoActivity", "locationChangeBroadcastReceiver");
