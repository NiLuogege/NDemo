...
//    public static SPUtils getInstance(Application context, String spName) {
//        if (sp == null) {
...
//        return spUtils;
//    }
    public static SPUtils getInstance(Application context) {
        if (sp == null) {
            synchronized (SPUtils.class) {
                if (sp == null) {
                    spUtils = new SPUtils(context, SettingsUtils.SP_NAME);
                    return spUtils;
                }
            }
        }
