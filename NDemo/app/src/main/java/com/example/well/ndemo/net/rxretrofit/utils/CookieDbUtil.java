package com.example.well.ndemo.net.rxretrofit.utils;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;

import com.example.well.ndemo.net.rxretrofit.RxRetrofitApp;
import com.example.well.ndemo.net.rxretrofit.gen.CookieResulteDao;
import com.example.well.ndemo.net.rxretrofit.gen.DaoMaster;
import com.example.well.ndemo.net.rxretrofit.gen.DaoSession;
import com.example.well.ndemo.net.rxretrofit.http.cookie.CookieResulte;
